...
impl QuicServer {
    ...
    pub fn with_socket_and_tls_config(
        ...
        let mut server_config =
            ServerConfig::with_crypto(Arc::new(QuicServerConfig::try_from(tls_config).map_err(|e| NetError::from(e))?));
    ...
    pub async fn next(&mut self) -> Result<Option<(QuicStreams, SocketAddr)>, NetError> {
        ...
        let connection = connecting.await.map_err(|e| NetError::from(e))?;
